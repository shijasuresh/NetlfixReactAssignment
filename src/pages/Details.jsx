    ...
    return(
        <>
            <div className="relative w-full h-[80vh] overflow-hidden">
                ...
                <div className="absolute left-24 top-56 w-[600px]">
                ...
                <button onClick={volumeHandler} className="absolute top-96 right-10 border border-white rounded-full h-10 w-10 flex items-center justify-center">{volume ? <MuteIcon />  : <UnmuteIcon /> }</button>
            </div>
